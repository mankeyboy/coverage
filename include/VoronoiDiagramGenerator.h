...
public:
	...
	bool generateVoronoi(vector<float> xValues, vector<float> yValues, int numPoints, float minX, float maxX, float minY, float maxY, float minDist);
	//void MapGenerator(Mat img);
	void resetIterator()
	{
...
private:
	...
	//void GetClipPoint(int x1, int y1, int x2, int y2, float& resx, float& resy);
